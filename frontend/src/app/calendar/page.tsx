...
import { AlertCircle, Loader2, Calendar, RefreshCw, Smartphone } from "lucide-react"
          ...
          <CardContent className="py-12">
            <div className="flex flex-col items-center justify-center text-center">
              {error.includes("Device not connected") ? (
                ...
                <p className="text-muted-foreground">Unable to load calendar data. Please try again later.</p>
              )}
            </div>
          </CardContent>
        </Card>
